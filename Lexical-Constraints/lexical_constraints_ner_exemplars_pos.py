...
3. The documentshould have a part-of-speech sequence similar to: {pos_seq}.
...
1. The document should have the following keywords: {inc_kws}, but should not have the following keywords : {exc_kws}.
2. The document should be on the {topic_kw}: {topic}. Here are also some examples: {exemplars}.
3. The document should have a part-of-speech sequence similar to: {pos_seq}.
4. The document should have a length of {min_words}-{max_words} words."""
        ]
...
2. The document should have a part-of-speech sequence similar to: {pos_seq}.
